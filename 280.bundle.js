    ...
    3280: (t, n, e) => {
      ...
      ((z = new WeakMap()),
        ...
        (q = function (t) {
          ...
          null == t
            ...
            : ((n = "images/countries/" + t.code + ".svg"), (e = t.name));
          ...
          return { searchNames: l, button: s };
        }),
        (V = function () {
          const t = (0, i.gn)(this, O, "f")
            .value.trim()
            .toLowerCase()
            .split(" ");
          let n = !1;
          for (const { searchNames: e, button: s } of (0, i.gn)(this, R, "f")) {
            const i = e.flatMap((t) => t.split(" "));
            t.every((t) => i.some((n) => n.startsWith(t)))
              ? ((n = !0), (s.style.display = ""))
      ...
      const X = class {
        constructor(t, n, e, s, o) {
          ...
          ((h.className = "search-bar-container"),
            ...
            ((0, i.gn)(this, O, "f").spellcheck = !1),
            ((0, i.gn)(this, O, "f").autocomplete = "off"),
            ((0, i.gn)(this, O, "f").enterKeyHint = "search"),
            ((0, i.gn)(this, O, "f").placeholder = (0, i.gn)(this, z, "f").get(
              "Search country...",
            )),
          ...
          ((d.src = "images/search.svg"),
            ...
            ((0, i.gn)(this, B, "f").textContent = (0, i.gn)(this, z, "f").get(
              "No countries found",
            )),
          ...
          for (const t of f) {
            const { searchNames: n, button: s } = (0, i.gn)(
              this,
              T,
              "m",
              q,
            ...
            (t?.code == e && (g = s),
              (0, i.gn)(this, R, "f").push({ searchNames: n, button: s }));
          }
          ...
          ((u.className = "button"),
            ...
            null != g &&
              ...
              ((0, i.gn)(this, D, "f").scrollTop = Math.max(
                0,
                g.offsetTop -
                  (0, i.gn)(this, D, "f").offsetTop -
                  (0, i.gn)(this, D, "f").clientHeight / 2 +
                  g.clientHeight / 2,
              ))),
      ...
      ((Y = new WeakMap()),
        ...
        ($ = function () {
          ...
          return (
            /\S/.test(t) || (t = "Anonymous"),
            { nickname: t, countryCode: (0, i.gn)(this, J, "f") }
          );
        }));
      const tt = class {
        constructor(t, n, e, s, o, a, l, c, r) {
          ...
          ((m.className = "title"),
            ...
            (0, i.gn)(this, j, "f").addEventListener("input", () => {
              let t = (0, i.gn)(this, j, "f").value;
              for (; (0, A.k)(t) >= 50; ) t = t.substring(0, t.length - 1);
          ...
          ((P.className = "button delete"),
            (P.innerHTML =
              ' <img class="button-icon" src="images/delete.svg"> '),
        ...
        constructor(t, n, e, s, o) {
          ...
          if (
            ...
            ((e.className = "button right"),
              (e.innerHTML =
                '<img class="button-icon" src="images/import.svg"> '),
      ...
      ((dt = new WeakMap()),
        ...
        (bt = function (t, n, e) {
          ...
          if (
            ...
            n == (0, i.gn)(this, pt, "f").profileSlot &&
      ...
      ((Lt = new WeakMap()),
        ...
        (Vt = function () {
          (((0, i.gn)(this, It, "f").style.left =
            "calc(" +
            ((100 * (0, i.gn)(this, Dt, "f")) / 360).toString() +
            "% - 1px)"),
            ((0, i.gn)(this, St, "f").style.backgroundImage =
              "linear-gradient(transparent, #000), linear-gradient(to right, transparent, hsla(" +
              (0, i.gn)(this, Dt, "f").toString() +
              ", 100%, 50%, 1))"));
        }),
        (Xt = function () {
          (((0, i.gn)(this, Tt, "f").style.left =
            "calc(" + (0, i.gn)(this, Ot, "f").toString() + "% - 6px)"),
            ((0, i.gn)(this, Tt, "f").style.top =
              "calc(" +
              (100 - (0, i.gn)(this, Ht, "f")).toString() +
              "% - 6px)"));
        }));
      const Qt = class {
        constructor(t, n) {
          ...
          ((0, i.GG)(
            ...
            (0, i.gn)(this, St, "f").addEventListener(
              "touchstart",
              (0, i.gn)(this, Rt, "f"),
            ),
            (0, i.gn)(this, St, "f").addEventListener(
            ...
            (0, i.gn)(this, Pt, "f").addEventListener(
              "touchstart",
              (0, i.gn)(this, Ft, "f"),
            ),
            (0, i.gn)(this, Pt, "f").addEventListener(
        ...
        set color(t) {
          const { h: n, s: e, l: o } = t.getHSL({ h: 0, s: 0, l: 0 }, s.er$),
      ...
      class kn {
        constructor(t, n, e, o, a, l, c) {
          ...
          for (let s = 0; s < y.A.patterns.length; s++) {
            ...
            (a.addEventListener("click", () => {
              (t.playUIClick(),
                (0, i.gn)(this, jt, "f").isPatternUnlocked(s)
                  ? ((0, i.GG)(this, Kt, s, "f"),
                        ...
                        xn.$L("unlock-pattern").then((t) => {
                          t.success
                            ? ((0, i.GG)(this, Kt, s, "f"),
                              (0, i.gn)(this, Yt, "m", gn).call(this),
                              (0, i.gn)(this, Yt, "m", dn).call(this),
                              null != o && (a.removeChild(o), (o = null)),
                              (0, i.gn)(this, jt, "f").unlockPattern(s))
                            : e.show(
                                n.get("Ad not completed"),
                                n.get("Ok"),
                                null,
                              );
                        });
              ...
              s == (0, i.gn)(this, Kt, "f") && a.classList.add("selected"),
          ...
          for (let o = 0; o < y.A.rims.length; o++) {
            ...
            (l.addEventListener("click", () => {
              (t.playUIClick(),
                (0, i.gn)(this, jt, "f").isRimsUnlocked(o)
                  ? ((0, i.GG)(this, $t, o, "f"),
              ...
              o == (0, i.gn)(this, $t, "f") && l.classList.add("selected"),
            ...
            ((r.className = "loading"),
              kt
                .F(c, (0, i.gn)(this, hn, "f"), {
                  position: new s.Pq0(1e3, 0.19190498995780947, 1.3478),
          ...
          for (let o = 0; o < y.A.exhausts.length; o++) {
            ...
            (l.addEventListener("click", () => {
              (t.playUIClick(),
                (0, i.gn)(this, jt, "f").isExhaustUnlocked(o)
                  ? ((0, i.GG)(this, tn, o, "f"),
              ...
              o == (0, i.gn)(this, tn, "f") && l.classList.add("selected"),
          ...
          const f = [
            { title: n.get("Paint"), icon: "images/paint.svg", panel: h },
            {
              title: n.get("Pattern"),
              ...
              e.addEventListener("click", () => {
                ...
                (h.classList.add("hidden"),
                  ...
                  p != n &&
                    (n.panel == h
                      ? c(new s.Pq0(0, 2, 6))
                      : n.panel == (0, i.gn)(this, nn, "f")
                        ? ((0, i.gn)(this, Yt, "m", un).call(this),
                          c(new s.Pq0(0, 2, 6)))
                        : n.panel == (0, i.gn)(this, sn, "f")
        ...
        setCarStyle(t) {
          ((0, i.GG)(this, Kt, t.pattern, "f"),
            ...
            (0, i.gn)(this, jt, "f").isPatternUnlocked(
              (0, i.gn)(this, Kt, "f"),
            ) ||
              (0, i.gn)(this, jt, "f").unlockPattern((0, i.gn)(this, Kt, "f")),
            (0, i.gn)(this, jt, "f").isRimsUnlocked((0, i.gn)(this, $t, "f")) ||
              (0, i.gn)(this, jt, "f").unlockRims((0, i.gn)(this, $t, "f")),
            (0, i.gn)(this, jt, "f").isExhaustUnlocked(
              (0, i.gn)(this, tn, "f"),
            ) ||
      ...
      ((_t = kn),
        ...
        (dn = function () {
          const t = new y.A(
            ...
            (0, i.gn)(this, $t, "f"),
            (0, i.gn)(this, tn, "f"),
            (0, i.gn)(this, cn, "f")[0].color.getHex(),
            (0, i.gn)(this, cn, "f")[1].color.getHex(),
            (0, i.gn)(this, cn, "f")[2].color.getHex(),
            (0, i.gn)(this, cn, "f")[3].color.getHex(),
          );
        ...
        (wn = function (t, n) {
          if (t.scrollTo) {
            ...
            t.scrollTo({ top: i, behavior: "instant" });
          } else
            n.scrollIntoView({
              behavior: "instant",
              block: "nearest",
      ...
      ((Sn = new WeakMap()),
        ...
        (le = function () {
          ...
          let r, h;
          Math.random() < 0.9
            ? ((r = 100 * (1 - Math.pow(Math.random(), 2))),
              (h = 100 * (0.05 + 0.25 * (1 - Math.pow(Math.random(), 2)))))
            : ((r = 0), (h = 100 * Math.random()));
          const d = new s.Q1f(
            "hsl(" +
              c.toString() +
              "," +
          ...
          ((g =
            ...
            Math.random() < 0.9
              ? ((f = r),
                (p = 100 * (0.05 + 0.25 * (1 - Math.pow(Math.random(), 2)))))
              : ((f = 0), (p = 100 * Math.random())));
          const u = new s.Q1f(
            "hsl(" +
              g.toString() +
              "," +
              ...
              (e) => {
                ((0, i.gn)(this, Bn, "f")?.dispose(),
                  ...
                  (0, i.gn)(this, On, "f").showConfirm(
                    ...
                    (0, i.gn)(this, zn, "f").get("Cancel"),
                    (0, i.gn)(this, zn, "f").get("Confirm"),
                    () => {
                    ...
                    () => {
                      if (
                        ...
                        n == (0, i.gn)(this, Hn, "f").profileSlot)
                      ) {
                        ((0, i.gn)(this, Hn, "f").setProfileSlot(
                          (0, i.gn)(this, Hn, "f").firstOccupiedProfileSlot() ??
                            0,
                        ),
                          (0, i.GG)(
                            this,
                ...
                ((0, i.gn)(this, Fn, "f")?.dispose(),
                  ...
                  (0, i.gn)(this, Hn, "f").hasDuplicateToken(e)
                    ? (0, i.gn)(this, On, "f").show(
                        ...
                        (0, i.gn)(this, zn, "f").get("Ok"),
                        () => {
                          (0, i.gn)(this, Wn, "m", t).call(this, n, e);
                        },
                      )
                    : (0, i.gn)(this, Hn, "f").isValidToken(e)
                      ? (0, i.gn)(this, Un, "f")
                          .getUser(e)
                          .then((s) => {
                            if (null != s)
                              if (
                                (0, i.gn)(this, Hn, "f").createProfile(
                                  n,
                                  e,
                                  s.nickname,
                                  s.countryCode,
                      ...
                      : (0, i.gn)(this, On, "f").show(
                          (0, i.gn)(this, zn, "f").get("User token is invalid"),
                          (0, i.gn)(this, zn, "f").get("Ok"),
                          () => {
                            (0, i.gn)(this, Wn, "m", t).call(this, n, e);
                          },
          ...
          (0, i.gn)(this, se, "f")
            ? (0, i.gn)(this, On, "f").showConfirm(
                (0, i.gn)(this, zn, "f").get(
                  ...
                  "\n\n" +
                  (0, i.gn)(this, zn, "f").get("All changes will be lost!"),
                (0, i.gn)(this, zn, "f").get("Cancel"),
                (0, i.gn)(this, zn, "f").get("Confirm"),
                null,
                () => {
                  ...
                  ((0, i.gn)(this, se, "f")
                    ? (0, i.gn)(this, On, "f").showConfirm(
                        e.get(
                          ...
                          "\n\n" +
                          e.get("All changes will be lost!"),
                        e.get("Cancel"),
                        e.get("Confirm"),
                        null,
                        () => {
                        ...
                        if (t instanceof s.eaF) {
                          if (Array.isArray(t.material))
                            for (let n = 0; n < t.material.length; n++) {
                              ...
                              t.material[n] = new s.G_z({ color: e.color });
                            }
                          else
                            t.material = new s.G_z({ color: t.material.color });
