    ...
    7112: (t, e, n) => {
      ...
      const K = class {
        constructor(t, e, n, s) {
          (T.add(this),
            ...
            (0, i.GG)(this, D, e, "f"),
            (0, i.GG)(this, I, s, "f"),
            (0, i.GG)(this, O, document.createElement("div"), "f"),
            ((0, i.gn)(this, O, "f").className = "hidden"),
            t.appendChild((0, i.gn)(this, O, "f")),
            (0, i.gn)(this, I, "f").addChangeListener(
              (0, i.GG)(
                ...
                (t) => {
                  t
                    ? (0, i.gn)(this, O, "f").classList.add("touch")
                    : (0, i.gn)(this, O, "f").classList.remove("touch");
                },
                "f",
              ),
            ));
          const o = document.createElement("div");
          ((o.className = "buttons"), (0, i.gn)(this, O, "f").appendChild(o));
          ...
          ((l.src = "images/arrow_down.svg"),
            ...
            (0, i.gn)(this, O, "f").appendChild((0, i.gn)(this, B, "f")),
            (0, i.gn)(this, T, "m", H).call(this));
        }
        dispose() {
          ((0, i.gn)(this, q, "f").removeChild((0, i.gn)(this, O, "f")),
            (0, i.gn)(this, I, "f").removeChangeListener(
              (0, i.gn)(this, U, "f"),
            ));
        }
        hide() {
          ((0, i.gn)(this, O, "f").classList.add("hidden"),
            (0, i.gn)(this, O, "f").classList.remove(
              "editor-checkpoint-order-ui",
            ));
        }
        show() {
          ((0, i.gn)(this, O, "f").classList.remove("hidden"),
            (0, i.gn)(this, O, "f").classList.add(
              "editor-checkpoint-order-ui",
            ));
        }
        reset() {
      ...
      const Wt = class {
        constructor(t, e, n, s, o, a, r, h) {
          ...
          ((I.className = "button-wrapper"), d.appendChild(I));
          const O = document.createElement("button");
          ((O.className = "button"),
            (O.innerHTML =
              '<img class="button-icon" src="images/cancel.svg"> '),
            O.append(document.createTextNode(e.get("Close"))),
      ...
      const fi = class {
        constructor(t, e, n, s, o, a, r, h, l, c, d, g, f, p) {
          (Kt.add(this),
            ...
            ((0, i.gn)(this, De, "f").maxPolarAngle = Math.PI / 2),
                    ...
                    t.ctrlKey || t.metaKey
                      ...
                      : (f.checkKeyBinding(t, st.A.EditorRotatePart) &&
                        ...
                        f.checkKeyBinding(t, st.A.EditorMoveForwards) &&
                          ((0, i.GG)(this, Oe, !0, "f"), t.preventDefault()),
                    ...
                    n()
                      .then((e) => {
                        ...
                        ((0, i.gn)(this, jt, "f").loadTrackData(e),
                          ...
                          ((0, i.gn)(this, ge, "f").disabled = !0),
                          ((0, i.gn)(this, fe, "f").disabled = !0),
                          (0, i.gn)(this, Kt, "m", On).call(this, t),
                          (0, i.GG)(this, Ye, !0, "f"));
