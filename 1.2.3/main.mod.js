import {
  PolyMod,
  MixinType,
} from "https://cdn.polymodloader.com/cb/polytrackmods/PolyModLoader/0.6.0-beta1/PolyTypes.js";
  ...
  init = (pmlInstance) => {
    ...
    this.modPmlInstance.registerFuncMixin(
      ...
      `
        ...
        (0, R.gn)(this, Qc, "f").appendChild(modButton);
        (0, R.gn)(this, Jc, "f").push(modButton);
      `
    );
  };
  postInit = () => {
