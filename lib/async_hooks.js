var c = class {
    ...
    run(e, r, ...t) {
        ...
        let n = r(...t);
        return this._currentStore = void 0,
        n
    }
    exit(e, ...r) {
  ...
  , S = globalThis.AsyncLocalStorage || c
  , R = Symbol("init")
  , a = Symbol("before")
  , o = Symbol("after")
  , i = Symbol("destroy")
  , A = Symbol("promiseResolve")
  , T = class {
    __unenv__ = !0;
    _enabled = !1;
    _callbacks = {};
  ...
  , y = class {
    ...
    constructor(e, r=s()) {
        this.type = e,
        this._asyncId = -1 * _++,
        this._triggerAsyncId = typeof r == "number" ? r : r?.triggerAsyncId
    }
    static bind(e, r, t) {
        return new E(r ?? "anonymous").bind(e)
    }
    bind(e, r) {
        let t = (...n) => this.runInAsyncScope(e, r, ...n);
        return t.asyncResource = this,
        t
    }
    runInAsyncScope(e, r, ...t) {
        return e.apply(r, t)
    }
    emitDestroy() {
        return this
  ...
  , E = globalThis.AsyncResource || y
  , b = {
    asyncWrapProviders: I,
    AsyncLocalStorage: S,
    AsyncResource: E,
    createHook: P,
    executionAsyncId: s,
    executionAsyncResource: u,
    triggerAsyncId: l
};
export {S as AsyncLocalStorage, E as AsyncResource, I as asyncWrapProviders, P as createHook, b as default, s as executionAsyncId, u as executionAsyncResource, l as triggerAsyncId};
