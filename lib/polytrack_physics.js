async function PolyTrackPhysics(t = {}) {
  ...
  function b() {
    return (
      (t = "polytrack_physics.wasm"),
      e.locateFile ? e.locateFile(t, o) : o + t
    );
    var t;
  }
  async function A(t) {
  ...
  if (
    (e.noExitRuntime && (E = e.noExitRuntime),
    e.print && (d = e.print),
    e.printErr && (m = e.printErr),
  ...
  var V,
    Y = {
      i: (t, r, e, n) =>
        _(
          `Assertion failed: ${B(t)}, at: ` +
            [r ? B(r) : "unknown filename", e, n ? B(n) : "unknown function"],
        ),
      a: (t, r, e) => {
      ...
      d: (t, r) => {
        ...
        return ((L[t] = { id: e, timeout_ms: r }), 0);
      },
      h: () => Date.now(),
      f: (t) => {
        var r,
        ...
        for (var i = 1; i <= 4; i *= 2) {
          ...
          var s = Math.min(
            a,
            ((r = Math.max(t, o)), (e = 65536), Math.ceil(r / e) * e),
          );
          if (X(s)) return !0;
        }
        return !1;
      ...
      function t(t, r) {
        return (
          (function (t) {
            ((e._malloc = t.l),
              (e._free = t.m),
              (e._initializeCarCollisionShape = t.n),
              (e._addTrackPartConfiguration = t.o),
              (e._createCarModel = t.p),
              (e._deleteCarModel = t.q),
              (e._updateCarModel = t.r),
              (e._testDeterminism = t.s),
              (j = t.t),
              (F = t.u),
              (W = t.v),
              (D = t.w),
...
"object" == typeof exports && "object" == typeof module
  ? ((module.exports = PolyTrackPhysics),
    (module.exports.default = PolyTrackPhysics))
  : "function" == typeof define &&
    define.amd &&
    define([], () => PolyTrackPhysics);
