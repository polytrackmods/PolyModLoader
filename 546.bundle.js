  ...
  [546],
  {
    6546: (e, t, n) => {
              ...
              const p = (i) => {
                  ...
                  const o = (...o) => {
                    const c = (async () => (
                      !m && u in l
                        ? (m = m =
                            "function" == typeof l[u] ? await l[u]() : l[u])
                        : null !== t &&
                          !m &&
                          "web" in l &&
                          (m = m =
                      ...
                      const c = ((t, i) => {
                        ...
                        if (!h) {
                          if (t)
                            return null === (o = t[i]) || void 0 === o
                              ? void 0
                              : o.bind(t);
                          throw new r(
                            `"${e}" plugin is not implemented on ${u}`,
                            s.Unimplemented,
                          );
                        }
                        {
                          const s =
                            null == h
                              ? void 0
                              : h.methods.find((e) => i === e.name);
                          if (s)
                            return "promise" === s.rtype
                              ? (t) => n.nativePromise(e, i.toString(), t)
                              : (t, s) =>
                                  n.nativeCallback(e, i.toString(), t, s);
                          if (t)
                      ...
                      throw new r(
                        `"${e}.${i}()" is not implemented on ${u}`,
                        s.Unimplemented,
                      );
                    });
                    return (
                      "addListener" === i && (c.remove = async () => a()),
                      c
                    );
                  };
                  return (
                    (o.toString = () =>
                      `${i.toString()}() { [capacitor code] }`),
                ...
                g = p("removeListener"),
                f = (e, t) => {
                  const n = w({ eventName: e }, t),
                    s = async () => {
                      const s = await n;
                      g({ eventName: e, callbackId: s }, t);
                    },
                    r = new Promise((e) => n.then(() => e({ remove: s })));
                  return (
                    (r.remove = async () => {
                      (console.warn(
      ...
      class c {
        ...
        hasListeners(e) {
          var t;
          return !!(null === (t = this.listeners[e]) || void 0 === t
            ? void 0
            : t.length);
        }
        ...
        async setCookie(e) {
          try {
            const t = l(e.key),
              n = l(e.value),
              s = e.expires
                ? `; expires=${e.expires.replace("expires=", "")}`
                : "",
      ...
      class m extends c {
        async request(e) {
                    ...
                    .reduce((e, n) => {
                      ...
                      return (
                        Array.isArray(r)
                          ? ((a = ""),
                            r.forEach((e) => {
                              ((i = t ? encodeURIComponent(e) : e),
                                (a += `${s}=${i}&`));
                            }),
                            a.slice(0, -1))
                          : ((i = t ? encodeURIComponent(r) : r),
                            (a = `${s}=${i}`)),
                        `${e}&${a}`
                      );
                    }, "")
          ...
          return (
            ...
            { data: a, headers: l, status: r.status, url: r.url }
          );
        }
        async get(e) {
          return this.request(
