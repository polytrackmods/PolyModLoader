import {
  PolyMod,
  MixinType,
} from "https://cdn.polymodloader.com/cb/polytrackmods/PolyModLoader/0.6.0-beta3/PolyTypes.js";
  ...
  init = (pmlInstance) => {
    ...
    this.modPmlInstance.registerFuncMixin(
      ...
      `
        ...
        (0, C.gn)(this, Fc, "f").appendChild(modButton);
        (0, C.gn)(this, Oc, "f").push(modButton);
      `
    );
  };
  postInit = () => {
